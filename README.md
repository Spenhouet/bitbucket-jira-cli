<p align="center">
  <a href="https://github.com/Spenhouet/bitbucket-jira-cli"><img src="https://raw.githubusercontent.com/Spenhouet/bitbucket-jira-cli/main/docs/img/banner.png" style="border-radius: 15px;" alt="bitbucket-jira-cli"></a>
</p>
<p align="center">
...
```bash
curl -LsSf uvx.sh/bitbucket-jira-cli/1.3.0/install.sh | sh
```
