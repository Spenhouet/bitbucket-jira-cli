...
def _guide_bitbucket() -> None:
    ...
    console.print(
        ...
        f"    read:snippet:bitbucket, write:snippet:bitbucket, delete:snippet:bitbucket,\n"
        f"    read:webhook:bitbucket, write:webhook:bitbucket, delete:webhook:bitbucket\n"
...
def _guide_jira() -> None:
    ...
    console.print(
        ...
        f"    automatically). Note: `bj board` needs the unscoped token below —\n"
        f"    Atlassian rejects scoped API tokens on the Jira agile API.\n"
